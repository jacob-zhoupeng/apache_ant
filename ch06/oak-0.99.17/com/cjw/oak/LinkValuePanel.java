...
class LinkValuePanel extends ValuePanel implements ActionListener
{
	LinkGroupItem elem;
	ConfigurationPanel parent;
	Button linkButton;

		LinkValuePanel(LinkGroupItem elem, ConfigurationPanel parent)
	{
		this.elem = elem;
		this.parent = parent;
		linkButton = new Button(elem.getShortDescription());
	...
	{
		parent.handleLink(elem.getTargetClass(), elem.getGroupNum(), elem.getID());
	}
