...
class FloatValuesType implements PrimitiveType
{
	private double[] values;

		FloatValuesType(double[] values)
	{
		this.values = values;
	}
	...
	{
		int i;
		double stringFloatValue;
		
		try
		{
			stringFloatValue = Double.parseDouble(string);
		}
