...
public class DisjunctType implements PrimitiveType
{
	private PrimitiveType base, exclusion;
	
		DisjunctType(PrimitiveType base, PrimitiveType exclusion)
	{
		this.base = base;
	...
	{
		if (exclusion.acceptsValue(string))
			return false;
		
		return base.acceptsValue(string);
	}
}
