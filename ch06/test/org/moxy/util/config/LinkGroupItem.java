...
public class LinkGroupItem extends GroupItem
{
	private String targetClass;
	private int groupNum;

		public LinkGroupItem(String id, String shortDescription, 
							 String longDescription, String targetClass, int groupNum)
	{
